...
public class You100AddRequest extends StringRequest {

    final static private String URL = "https://tlsalsrn1.cafe24.com/Couple_you100_add.php";
    private Map<String, String> parameters;

    public You100AddRequest(String self50ID, String self50Answer1, String self50Answer2, String self50Answer3,
