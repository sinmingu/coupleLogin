...
public class Self100SendAddRequest extends StringRequest {

    final static private String URL = "https://tlsalsrn1.cafe24.com/Couple_self100_send_add.php";
    private Map<String, String> parameters;

    public Self100SendAddRequest(String self50ID, String self50Answer1, String self50Answer2, String self50Answer3,
