...
public class Bucket10UpdateRequest extends StringRequest {

    final static private String URL = "https://tlsalsrn1.cafe24.com/Couple_bucket10_update.php";
    private Map<String, String> parameters;

    public Bucket10UpdateRequest(String self50ID, String self50Answer1, String self50Answer2, String self50Answer3,
