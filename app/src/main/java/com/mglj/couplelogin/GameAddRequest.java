...
public class GameAddRequest extends StringRequest {

    final static private String URL = "https://tlsalsrn1.cafe24.com/Couple_game_add.php";
    private Map<String, String> parameters;

    public GameAddRequest(String gameID, int gameCode, String gameAnswer1, String gameAnswer2, String gameAnswer3,
