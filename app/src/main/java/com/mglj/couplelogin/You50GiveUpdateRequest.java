...
public class You50GiveUpdateRequest extends StringRequest {

    final static private String URL = "https://tlsalsrn1.cafe24.com/Couple_you50_give_update.php";
    private Map<String, String> parameters;

    public You50GiveUpdateRequest(String self50ID, String self50Answer1, String self50Answer2, String self50Answer3,
